        ...
        for (const poi of pois) {
          ...
          sgMail.send({
            ...
            html:
              ...
              ` <a href=http://localhost:3001/#/report/${poi.id}>this website</a><br/><br/>Kind regards, <br/> GoGiro.`,
            attachments: [
              {
